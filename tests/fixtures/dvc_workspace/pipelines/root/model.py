...
def find_hyperparameters() -> None:
    ...
    with Path("pipelines/root/files/hyperparameters.json").open("w") as file:
...
def train_model(
    ...
    """Train model."""
    with Path("pipelines/root/files/dataset.json").open() as file:
        dataset = json.load(file)

    with Path("pipelines/root/files/hyperparameters.json").open() as file:
    ...
    with Path("pipelines/root/files/blue.json").open() as file:
    ...
    directory = Path("pipelines/root/files/")
