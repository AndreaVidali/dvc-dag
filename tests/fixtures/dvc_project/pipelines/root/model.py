...
def find_hyperparameters() -> None:
    ...
    with Path("pipelines/root/data/hyperparameters.json").open("w") as file:
...
def train_model(
    ...
    """Train model."""
    with Path("pipelines/root/data/dataset.json").open() as file:
        dataset = json.load(file)

    with Path("pipelines/root/data/hyperparameters.json").open() as file:
    ...
    with Path("pipelines/root/data/blue.json").open() as file:
    ...
    directory = Path("pipelines/root/data/")
